...
public class SqlQueryActionTest extends TestCase {
    ...
    public void testQueryTimeout() throws Exception {
        ...
        ActionSequenceDocument doc2 = new ActionSequenceDocument(parseText(xml));
        assertNotNull(doc2);
    ...
    /**
     * Creates a correct base instance of an action sequence document with one
     * empty SqlQueryAction.
     */
