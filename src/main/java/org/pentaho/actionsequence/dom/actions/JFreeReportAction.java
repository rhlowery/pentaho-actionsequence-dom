...
import static org.pentaho.actionsequence.dom.IActionSequenceDocument.HQL_QUERY_TYPE;
import static org.pentaho.actionsequence.dom.IActionSequenceDocument.MDX_QUERY_TYPE;
import static org.pentaho.actionsequence.dom.IActionSequenceDocument.RESULTSET_TYPE;
import static org.pentaho.actionsequence.dom.IActionSequenceDocument.SQL_QUERY_TYPE;
import static org.pentaho.actionsequence.dom.IActionSequenceDocument.XQUERY_TYPE;
...
public class JFreeReportAction extends ActionDefinition {
    ...
    public class StaticReportConfig extends AbstractList {
        ...
        public Object add(String paramName, String paramValue) {
            Element element
                    = makeElement(getElement(), COMPONENT_DEF_NAME + "/"
    ...
    public ActionInput[] getSubreportQueryParams() {
        ...
        IActionInput[] actionInputs
                = getInputs(new ActionInputTypeFilter(new String[]{RESULTSET_TYPE, MDX_QUERY_TYPE, SQL_QUERY_TYPE, XQUERY_TYPE, HQL_QUERY_TYPE}));
        for (IActionInput actionInput : actionInputs) {
            if (!actionInput.equals(mainReportData)) {
                subreportQueryParams.add(actionInput);
            }
        }
    ...
    public void setSubReportQueryParams(IActionInputVariable[] subQueryVariables) {
        ...
        if (subQueryVariables != null) {
            for (IActionInputVariable subQueryVariable : subQueryVariables) {
                setActionInputValue(subQueryVariable.getVariableName(), subQueryVariable);
            }
        }
    }
