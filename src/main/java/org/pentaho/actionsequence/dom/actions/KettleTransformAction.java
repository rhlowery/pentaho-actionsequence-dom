...
public class KettleTransformAction extends ActionDefinition {
    ...
    public static boolean accepts(Element element) {
        ...
        if (ActionDefinition.accepts(element) && hasComponentName(element, COMPONENT_NAME)) {
            result
                    = (element.selectSingleNode(ACTION_RESOURCES_NAME + "/" + TRANSFORMATION_FILE_ELEMENT) != null) //$NON-NLS-1$
                    || (element.selectSingleNode(ACTION_INPUTS_NAME
    ...
    public void setMonitorStep(IActionInputSource value) {
        setActionInputValue(TRANSFORMATION_STEP_ELEMENT_OLD, NULL_INPUT);
    ...
    public void setOutputSuccessResultSet(String publicOutputName) {
        setOutput(TRANSFORMATION_OUTPUT_ELEMENT, null, RESULTSET_TYPE);
        setOutput(TRANSFORM_SUCCESS_OUTPUT_ELEMENT, publicOutputName, RESULTSET_TYPE);
    }
    ...
    public void setOutputErrorResultSet(String publicOutputName) {
        setOutput(TRANSFORM_ERROR_OUTPUT_ELEMENT, publicOutputName, RESULTSET_TYPE);
    }
    ...
    public void setOutputSuccessCount(String publicOutputName) {
        setOutput(TRANSFORM_SUCCESS_COUNT_OUTPUT_ELEMENT, publicOutputName, INTEGER_TYPE);
    }
    ...
    public void setOutputErrorCount(String publicOutputName) {
        setOutput(TRANSFORM_ERROR_COUNT_OUTPUT_ELEMENT, publicOutputName, INTEGER_TYPE);
    }
    ...
    public void setOutputExecutionLog(String publicOutputName) {
        setOutput(EXECUTION_LOG_OUTPUT_ELEMENT, publicOutputName, STRING_TYPE);
    }
    ...
    public void setOutputExecutionStatus(String publicOutputName) {
        setOutput(EXECUTION_STATUS_OUTPUT_ELEMENT, publicOutputName, STRING_TYPE);
    }
    ...
    public IActionSequenceValidationError[] validate() {
        ArrayList<IActionSequenceValidationError> errors = new ArrayList<>();
        ...
        } else if (validationError.errorCode == INPUT_MISSING) {
        ...
        } else if (validationError.errorCode == INPUT_REFERENCES_UNKNOWN_VAR) {
