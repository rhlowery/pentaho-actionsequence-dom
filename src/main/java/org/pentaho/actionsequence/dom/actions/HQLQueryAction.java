...
public class HQLQueryAction extends HQLConnectionAction {
    ...
    public void setOutputResultSetName(String name) {
        setOutput(QUERY_RESULT_ELEMENT, name, RESULTSET_TYPE);
     ...
     * first output name that's not PREPARED_COMPONENT
        ...
        if (actionOutput == null) {
            ...
            if (actionOutput == null) {
                ...
                for (IActionOutput actionOutput1 : actionOutputs) {
                    if (!actionOutput1.getName().equals(PREPARED_COMPONENT_ELEMENT)) {
                        actionOutput = actionOutput1;
                        break;
                    }
                }
            }
    ...
    public void setOutputPreparedStatementName(String name) {
        setOutput(PREPARED_COMPONENT_ELEMENT, name, HQL_QUERY_TYPE);
        if ((name != null) && (name.trim().length() > 0)) {
