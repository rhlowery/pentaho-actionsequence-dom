...
public interface IActionDefinition extends IActionSequenceExecutableStatement {
    ...
    /**
     * Creates an input resource with the given name.The resource will reference
     * the specified action sequence resource. No operation is performed if the
     * resource already exists.
     *
     * @param privateResourceName the name of the resource as it is known by
     * this action definition (the element name).
     * @param referencedActionSequenceResource
     * @return the newly created or existing resource.
     */
    ...
    /**
     * Returns all the inputs that are listed in the action inputs section of
     * this action definition that are accepted by the given filter.
     *
     * @param actionInputFilter the input filter
     * @return the inputs of the specified types listed in the action inputs
